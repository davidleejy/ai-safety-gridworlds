...
```
pip install gym  # OpenAI gym. Alternatively, follow instructions at https://github.com/openai/gym

conda install pytorch torchvision -c pytorch # For installations that cater to different CUDA versions, see https://pytorch.org/
```
...
`cd /home/dl/code/torch-rl ; PYTHONPATH=/home/dl/code/torch-rl:./trlzzz:/home/dl/code/ai-safety-gridworlds python3 scripts/train-distribshift.py --env DistribShift-train-v0 --algo ppo --procs 16 --frames 1600000 --obs_type board --recurrence 1 --frames-per-proc 128 --entropy-coef 0.01 --model fresh --tb`
